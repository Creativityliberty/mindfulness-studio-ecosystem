...
type AnimationPreset = keyof typeof cssAnimationPresets;
type TransitionPreset = keyof typeof cssTransitionPresets;
...
function Dialog({ modal = true, ...props }: ComponentProps<typeof DialogPrimitive.Root>) {
	return (
...
function DialogViewport(props: ComponentProps<typeof DialogPrimitive.Viewport>) {
...
type DialogPopupProps = Omit<ComponentProps<"div">, "children"> & {
